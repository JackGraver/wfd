export default function RestaurantModal({
    ...
    return (
        <div className="bg-white w-[340px] max-w-md ml-6 mb-6 rounded-xl shadow-md hover:shadow-xl transition-shadow">
            <div className="bg-[#FFAFCC] h-16 w-full rounded-t-xl flex items-center justify-end px-4 space-x-2">
                <EditSVG onEdit={onEdit} />
                <DeleteSVG onDelete={onDelete} />
            </div>
...
function EditSVG({ onEdit }: { onEdit: (set: boolean) => void }) {
    return (
        <button
            onClick={() => onEdit(true)}
